...
router.get('/', function (req, res) {
 res.render('index', { title: 'starbucks App', user : req.user });
});
router.get('/register', function(req, res) {
 res.render('register', { title: 'starbucks App Registration'});
});
...
router.get('/login', function(req, res) {
 res.render('login', { title: 'starbucks App Login', user : req.user });
});
